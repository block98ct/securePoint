...
app.get('/getAllAssetsOfUser', authenticateToken,  handleValidationErrors,  userController.getAllAssetDetails)
...
app.get('/getUserProfileAndAssets', authenticateToken,  handleValidationErrors,  userController.getUserProfileAndAssets)   
app.get('/randomAssets', authenticateToken,  handleValidationErrors,  userController.randomAssetDetails)   
...
app.delete('/deleteUnverifiedUser',  handleValidationErrors, userController.deleteUnverfiedUsers)
